...
function updateProfile(data) {
  if (data.message !== "Not Found") {
    ...
    // Creating new function checkNull which will be used later
    function checkNull(field, element) {
      if (field === null || field === "") {
        // element.parentElement.style.opacity = 0.5; // or some UI change
